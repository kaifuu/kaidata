...
const routes = [
  { path: '/login', name: 'Login', component: () => import('@/views/login/Index.vue'), meta: { public: true, title: '登录' } },
  {
    ...
    children: [
      ...
      { path: 'data-gov/meta', name: 'GovDataMap', component: () => import('@/views/data-gov/DataMap.vue'), meta: { title: '数据地图', icon: 'DataBoard' } },
      ...
      { path: 'data-dev/realtime', name: 'DevRealtime', component: () => import('@/views/data-dev/Realtime.vue'), meta: { title: '实时开发', icon: 'VideoPlay' } },
      { path: 'data-dev/script-dev', name: 'DevScriptDev', component: () => import('@/views/data-dev/ScriptDev.vue'), meta: { title: '脚本开发', icon: 'EditPen' } },
      { path: 'data-dev/tasklog', name: 'DevTaskLog', component: () => import('@/views/data-dev/TaskLog.vue'), meta: { title: '任务日志', icon: 'Document' } },
      // 数据资产
